...
## 🚀 Features
* **Raw Text Processing:** Paste any unformatted text for instant reading preparation.
...
* **Line Focus Tracker:** An interactive mouse-tracking tool that highlights the active sentence while dimming surrounding text to maintain user focus.

## 🛠️ Tech Stack
* **HTML5:** Semantic UI structure.
* **CSS3:** Custom properties for theme toggling and accessibility styling.
